// Simple Email Service for Art with Heart & Gifts
// Uses a reliable email service that works with Railway hosting
...
class EmailService {
  constructor() {
    ...
    this.fromEmail = config.emailUser;
    this.fromPassword = config.emailPass;
